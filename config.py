...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.horizontalScrollBar = QtWidgets.QScrollBar(self.groupBox_6)
        self.horizontalScrollBar.setGeometry(QtCore.QRect(10, 30, 171, 18))
        self.horizontalScrollBar.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalScrollBar.setObjectName("horizontalScrollBar")
        self.path_folder = QtWidgets.QLabel(self.groupBox_6)
        self.path_folder.setGeometry(QtCore.QRect(10, 0, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.path_folder.setFont(font)
        self.path_folder.setStyleSheet("background-color: rgba(255, 255, 255, 0);")
